...
public class MainDamActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
        infoTextView=findViewById(R.id.txt_display_info);
        //
        detailsTextView=findViewById(R.id.txt_display_details);
    }
...
//                        DaemonEnv.startServiceSafely(MainDamActivity.this,MainWorkService.class);
//                    }
//                },1000);
                //
                isCanStartWorkService = true;
...
//                buildNotify(this);
    ...
    public void onLocationChanged(LocationEvent event) {
        ...
        //
        builder.append("------"+event.getPointCount()+"-------------");
        ...
        //
        //
        detailsTextView.setText(totalInfo);
